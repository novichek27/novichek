    ...
    <main class="wrapper background-backgroundcolor">
        <section class="section">
            ...
            <div class="call-to-action">
                <section class="button-section"> <a class="destination-target_url" id="destination_url" href="ПАРТНЕРСКАЯ ССЫЛКА"> <button type="submit" class="action-button button button-shape button-backgroundcolor"> <span class="button-text button-fontcolor">ДА</span> </button></a>
                </section>
            </div>
        </section>
    </main>
